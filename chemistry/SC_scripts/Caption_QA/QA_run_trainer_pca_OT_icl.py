import gc
import torch
from chemistry.SC_scripts.QA_trainer_pca_OT_icl import run as run_base_batch
import argparse
...
def parse_args():
    ...
    parser.add_argument("--task_name", type=str, choices=["Property","Source","Structure","Usage"], default="ChEBI-20", help="Task name.")

    parser.add_argument("--instruction_prompt_name", type=str, default="MoleculeQA", help="Instruction prompt name.")
