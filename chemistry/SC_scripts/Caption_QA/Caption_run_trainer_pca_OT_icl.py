import gc
import torch
from chemistry.SC_scripts.Caption_trainer_pca_OT_icl import run as run_base_batch
import argparse
...
def parse_args():
    ...
    parser.add_argument("--n_representation_shots", type=int, default=100, help="Number of shots for the representation.")
