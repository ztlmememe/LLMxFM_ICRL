import gc
import torch
from chemistry.SC_scripts.ESM_trainer_pca_icl_baseline import run as run_base_batch
import argparse

def parse_args():
    parser = argparse.ArgumentParser(description="Run ESM experiments.")
    ...
    parser.add_argument("--num_tests", type=int, default=1000, help="Number of tests to run.")
    parser.add_argument("--num_trains", type=int, default=5000, help="Number of train sets to run.")
