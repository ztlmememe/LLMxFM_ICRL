import gc
import torch
from chemistry.SC_scripts.ESM_trainer_contrastive_icl import run as run_base_batch
import argparse
...
def parse_args():
    ...
    parser.add_argument("--esm_cache_path", type=str, default="/home/chanalvin/cache/hub", help="Path to the ESM cache.")
...
if __name__ == "__main__":
    ...
    run_base_batch(sampling_type="stratified", random_seed=args.seed,
                    ...
                    esm_cache_path=args.esm_cache_path,
