import gc
import torch
from chemistry.SC_scripts.ESM_trainer_pca_OT_icl_no_batch import run as run_base_batch
import argparse
...
def parse_args():
    ...
    parser.add_argument("--esm_model_name", type=str, default="facebook/esm2_t30_150M_UR50D", help="ESM model name.")
