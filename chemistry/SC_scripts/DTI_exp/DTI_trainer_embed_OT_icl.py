...
# data.harmonize_affinities(mode = 'mean')
    ...
    with torch.no_grad():
        ...
        print("all MOL_embed_train_tensor.shape: ", embed_train_tensor.shape)
        ...
        embed_train_tensor = text_embeddings.squeeze(0)
        print("all PRO_embed_train_tensor.shape: ", embed_train_tensor.shape)
