import gc
import torch
from chemistry.SC_scripts.MOL_trainer_contrastive_icl import run as run_base_batch
import argparse
...
def parse_args():
    ...
    parser.add_argument("--proj_path", type=str, default="/home/chanalvin/LLMxFM/chemistry/SC_scripts", help="Path to the project directory.")
    parser.add_argument("--projector_type", type=str, default="MLP_Linear", help="Path to the project directory.")
